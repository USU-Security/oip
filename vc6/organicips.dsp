...
!MESSAGE 
!MESSAGE NMAKE /f "organicips.mak" CFG="organicips - Win32 Debug"
!MESSAGE 
...
!IF  "$(CFG)" == "organicips - Win32 Release"
...
!ELSEIF  "$(CFG)" == "organicips - Win32 Debug"
...
# ADD CPP /nologo /w /W0 /Gm /vmb /GX /ZI /Od /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /YX /FD /GZ /c
...
# ADD LINK32 SDL.lib SDL_image.lib cryptopp.lib ws2_32.lib /nologo /subsystem:windows /debug /machine:I386 /out:"Debug/oip.exe" /pdbtype:sept
